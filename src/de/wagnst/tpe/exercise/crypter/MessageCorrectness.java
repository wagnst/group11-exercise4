...
/**
 * Basic class to check if a message to encode, decode is at the correct format.
 * Checks length, set on a default maximum value "maxLetter" and if literals are
 * legal for the method on use.
 *
 * @author Max
 */
